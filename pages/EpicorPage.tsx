...
import { ArrowRight, Factory, TrendingUp, AlertTriangle, CheckCircle2, Settings, BarChart3, ShoppingCart, Users, ShieldCheck } from 'lucide-react';
    ...
    <>
        ...
        <div className="container mx-auto px-4 md:px-6 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex justify-center gap-4">
              <a href="#contact" className="px-8 py-4 bg-blue-600 hover:bg-blue-500 text-white font-bold rounded-xl shadow-lg shadow-blue-900/50 transition-all hover:-translate-y-1 flex items-center gap-2">
      ...
      <section className="py-24 bg-blue-600 text-white relative overflow-hidden">
         ...
         <div className="container mx-auto px-4 md:px-6 text-center relative z-10">
            ...
            <a href="#contact" className="inline-flex items-center gap-2 bg-white text-blue-900 px-8 py-4 rounded-xl font-bold hover:bg-blue-50 transition-colors shadow-xl">
