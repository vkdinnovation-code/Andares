...
export const Process: React.FC = () => {
  ...
  const steps = [
    { number: '01', title: 'Audit ja Analüüs', icon: <Search size={24} /> },
    { number: '02', title: 'Lahenduse disain', icon: <PenTool size={24} /> },
    { number: '03', title: 'Juurutamine ja koolitus', icon: <Rocket size={24} /> },
    { number: '04', title: 'Tugi ja arendus', icon: <HeartHandshake size={24} /> },
  ];
