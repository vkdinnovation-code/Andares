...
export const Comparison: React.FC = () => {
  ...
  const features = [
    { label: 'Spetsialiseerumine', standard: false, andares: true },
    { label: 'Kohalik kasutajatugi', standard: false, andares: true },
    { label: 'Fikseeritud eelarve', standard: false, andares: true },
    { label: 'Juurutamise kiirus', standard: 'Aeglane', andares: 'Kiire' },
  ];
      ...
      <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="divide-y divide-slate-100">
             ...
             <div className="grid grid-cols-3 hover:bg-slate-50/50 transition-colors">
                ...
                <div className="p-6 md:p-8 flex items-center justify-center border-l border-slate-100 text-slate-400">
                   <X size={24} />
                   <span className="hidden md:inline ml-2 text-sm text-slate-400">(Üldine)</span>
                </div>
             ...
             <div className="grid grid-cols-3 hover:bg-slate-50/50 transition-colors">
                ...
                <div className="p-6 md:p-8 flex items-center justify-center border-l border-slate-100 text-slate-400">
                   <span className="text-sm font-medium">12+ kuud</span>
                </div>
                <div className="p-6 md:p-8 flex items-center justify-center border-l border-primary-100 bg-primary-50/10 text-primary-600 font-bold">
                   <Check size={20} className="mr-2" strokeWidth={3} />
                   <span className="text-sm">3-6 kuud</span>
                </div>
             </div>
        ...
        <div className="text-center mt-12">
            <div className="inline-flex items-center gap-2 text-slate-500 text-sm font-medium bg-white px-4 py-2 rounded-full shadow-sm border border-slate-200">
                ...
                <span>Garantii: Sinu äri ei peatu ülemineku ajal.</span>
            </div>
        </div>
