        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm font-medium">
              <li>
                <Link to="/#solutions" className="flex items-center gap-2 hover:text-primary-400 transition-colors group">
              ...
              <li>
                <Link to="/#industries" className="flex items-center gap-2 hover:text-primary-400 transition-colors group">
                  <span className="w-1.5 h-1.5 rounded-full bg-slate-700 group-hover:bg-primary-500 transition-colors"></span>
              ...
              <li>
                <Link to="/#modules" className="flex items-center gap-2 hover:text-primary-400 transition-colors group">
                  <span className="w-1.5 h-1.5 rounded-full bg-slate-700 group-hover:bg-primary-500 transition-colors"></span>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm font-medium">
              <li>
                <Link to="/#about" className="hover:text-white transition-colors">Andares Consulting OÜ</Link>
              </li>
              <li>
                <Link to="/#process" className="hover:text-white transition-colors">{t('nav.services')}</Link>
              </li>
              <li>
                <Link to="/#cases" className="hover:text-white transition-colors">{t('references.title')}</Link>
              </li>
              <li>
