      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="flex flex-col lg:flex-row gap-12 items-center">
          ...
          <div className="lg:w-1/3">
            ...
            <Link to="/#contact" className="inline-flex items-center gap-2 text-primary-700 font-bold border-b-2 border-primary-200 hover:border-primary-600 pb-1 transition-all group">
