        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-5xl mx-auto">
            ...
            <div className="flex flex-col bg-slate-50 rounded-3xl overflow-hidden border border-slate-100 hover:shadow-xl transition-all duration-300 group">
                ...
                <div className="p-8 flex flex-col flex-grow">
                    ...
                    <div className="mt-auto pt-6 border-t border-slate-200">
                        <Link to="/epicor" className="inline-flex items-center gap-2 text-slate-900 font-bold hover:text-primary-600 transition-colors group/btn">
            ...
            <div className="flex flex-col bg-slate-50 rounded-3xl overflow-hidden border border-slate-100 hover:shadow-xl transition-all duration-300 group">
                ...
                <div className="p-8 flex flex-col flex-grow">
                    ...
                    <div className="mt-auto pt-6 border-t border-slate-200">
                        <Link to="/iscala" className="inline-flex items-center gap-2 text-slate-900 font-bold hover:text-blue-600 transition-colors group/btn">
                           {t('solutions.learnMore')}
                           <ArrowRight size={18} className="group-hover/btn:translate-x-1 transition-transform" />
                        </Link>
                    </div>
